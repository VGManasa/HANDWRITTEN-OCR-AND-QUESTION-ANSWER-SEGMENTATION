...
### Input Image 1: images/handwritten_mcq.png
...
- **Quality**: Clear blue ballpoint pen handwriting

### Input Image 2: images/english_questions.png
...
### Output: raw_text.txt
Raw OCR text extracted from both images, preserving original formatting and line structure.

### Output: qa_pairs.txt
After processing both images, the script extracted and structured the following Q&A pairs:
